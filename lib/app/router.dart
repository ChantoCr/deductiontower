...
import 'package:anime_deduction_tower/features/online_multiplayer/presentation/screens/online_match_screen.dart';
...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: AppRoutes.onlineMatch,
      builder: (context, state) => const OnlineMatchScreen(),
    ),
    GoRoute(
