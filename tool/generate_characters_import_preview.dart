...
Future<void> main() async {
  ...
  final previewJson = service.generatePreviewJsonString(
  ...
  await File(AssetPaths.importCharactersPreviewData).writeAsString('$previewJson\n');
  stdout.writeln(
    'Generated ${AssetPaths.importCharactersPreviewData} from prototype MAL/Jikan import data.',
  );
}
